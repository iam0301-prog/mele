...
import { TeacherNumerologyVoicePreview } from '@/components/TeacherNumerologyVoicePreview';
...
export default async function TeacherPortalPage() {
  ...
  if (testUser) {
    ...
    return (
      <div className="container mx-auto max-w-5xl px-5 pb-10 pt-24">
        ...
        {locale === 'zh-TW' && <TeacherNumerologyVoicePreview />}
  ...
  const teacherWorkbenchCards = makeWorkbenchCards(bookingRows, chartByUser, draftByBooking, locale);
