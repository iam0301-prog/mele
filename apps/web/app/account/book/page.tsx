...
const BOOK_COPY: Record<Locale, BookCopy> = {
  'zh-TW': {
    ...
    intro: '預約會分成四步：確認服務、選擇時段、先讓老師理解你的問題、確認預約。目前全程免費，老師會依你的問題與附加命盤準備諮詢。',
    teacherServiceHint: '你即將預約這位老師的服務',
    freeTest: '目前免費：預約流程完整走完後不會產生任何費用。',
    serviceReminder: '建議先確認這項服務是否符合你的問題類型。預約後可在「我的諮詢」查看狀態與管理。',
    next: '下一步',
    back: '上一步',
    pickTimeTitle: '選擇時段',
    pickTimeSubtitle: 'PICK A TIME',
    pickTimeIntro: '下方只顯示老師近期開放且尚未被預約的時段。確認預約前，系統仍會以資料庫狀態再次確認，避免多人同時搶同一格。',
    noSlots: '老師近期無可預約時段',
    lineAsk: 'LINE 詢問',
    ...
    betaFreeLabel: '免費體驗',
    freeBadge: '免費',
    freeReviewNote: '目前全程免費體驗，確認後會直接建立預約並回到「我的諮詢」。',
    paidReviewNote: '確認後可在「我的諮詢」查看狀態、聯繫老師或取消預約。',
    cancelPolicyTitle: '取消說明',
    cancelPolicyLines: ['目前可隨時取消預約，不涉及任何費用。', '正式收費後將另行公告取消政策。'],
    submitting: '建立預約中...',
    confirmFree: '確認預約',
    confirmPay: '確認預約',
  ...
  en: {
    ...
    subtitle: 'BOOK A SESSION',
    intro: 'Booking has four steps: confirm the service, choose a time, help the guide understand your question, then confirm. All sessions are currently complimentary. The guide will prepare from your question and attached chart.',
    teacherServiceHint: 'You are booking this guide’s service',
    freeTest: 'Free: the full booking flow runs without any charges.',
    ...
    freeBadge: 'Free',
    freeReviewNote: 'All sessions are currently complimentary. Confirming will create the booking and return to My Sessions.',
    ...
    cancelPolicyLines: ['Bookings can be cancelled at any time at no cost.', 'Cancellation terms for paid sessions will be announced when billing opens.'],
    ...
    freeCreated: 'Booking confirmed. No charge was made.',
...
Object.assign(BOOK_COPY.vi, {
  ...
  freeBadge: 'Miễn phí',
  freeReviewNote: 'Tất cả buổi tư vấn hiện tại đều miễn phí. Xác nhận sẽ tạo lịch và quay về trang tư vấn của tôi.',
  ...
  cancelPolicyLines: ['Có thể hủy lịch bất cứ lúc nào, không phát sinh chi phí.', 'Điều khoản hủy cho buổi tính phí sẽ thông báo khi mở thanh toán.'],
  ...
  freeCreated: 'Đã đặt lịch miễn phí, không thu phí.',
...
Object.assign(BOOK_COPY.id, {
  ...
  freeBadge: 'Gratis',
  freeReviewNote: 'Semua sesi saat ini gratis. Konfirmasi akan membuat booking dan kembali ke halaman konsultasi saya.',
  ...
  cancelPolicyLines: ['Booking dapat dibatalkan kapan saja tanpa biaya.', 'Ketentuan pembatalan untuk sesi berbayar akan diumumkan saat tagihan dibuka.'],
  ...
  freeCreated: 'Booking gratis dibuat. Tidak ada biaya.',
