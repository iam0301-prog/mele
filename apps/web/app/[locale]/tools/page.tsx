...
const toolsBetaCopy = {
  'zh-TW': {
    ...
    boardItems: ['先跑一個不需要出生時間的工具', '確認結果是否看得懂、有沒有下一步', '再測點數解鎖或回報卡住處'],
    gridTitle: '工具公開測試狀態',
  ...
  en: {
    ...
    boardItems: ['Start with a tool that does not need birth time', 'Check whether the result is readable and has a next step', 'Then test point unlocks or report friction'],
