...
export const teacherCopies: Record<Locale, TeacherCopy> = {
  'zh-TW': {
    ...
    detail: {
      ...
      minutes: '分鐘',
      serviceNote: '預約前請確認這項服務符合你的問題類型。公測期間免費體驗，預約後可在「我的諮詢」查看狀態與管理紀錄。',
    ...
    apply: {
      ...
      submitNoticeItems: ['7-14 天審核（含試講）', '審核期間我們會通過 Email 與你聯繫', '上架後可在後台自助管理時段與服務項目', '公測期間平台不收取任何費用，正式收費規則將在公測結束後另行通知'],
      submit: '送出申請',
      submitting: '送出中…',
    ...
    portal: {
      ...
      memberBrief: {
        ...
        title: '會員詳解備忘',
        body: '會員前台先看簡易解釋；深入解釋、流日、流月、流年在公測期間可直接查看完整內容。老師端在諮詢前可先看會員提問與盤面脈絡，使解讀有本可循。',
  ...
  en: {
    ...
    apply: {
      ...
      submitNoticeItems: ['Review takes 7-14 days including a trial session.', 'We will contact you by email during review.', 'After publishing, schedule and services can be managed in the guide workspace.', 'No platform fees during open beta. Fee terms will be announced when billing opens.'],
    ...
    portal: {
      ...
      memberBrief: {
        ...
        body: 'Members see beginner readings first. Deeper readings, daily, monthly, and yearly transits are fully available during the open beta. Guides can review the question and chart context before a session.',
      ...
      tableTime: 'Time',
      tableStatus: 'Status',
      tableAmount: 'Beta status',
      tableReminder: 'Reminder',
      freeTest: 'Open beta — free',
...
teacherCopies.vi = inherit('vi', {
  ...
  portal: {
    ...
    memberBrief: {
      ...
      body: 'Thành viên xem giải thích cơ bản trước. Trong giai đoạn thử nghiệm mở, giải thích sâu hơn, ngày lưu, tháng lưu, năm lưu đều có thể xem đầy đủ. Guide có thể xem câu hỏi và bối cảnh lá số trước buổi tư vấn.',
    ...
    tableAmount: 'Trạng thái beta',
    tableReminder: 'Nhắc nhở',
    freeTest: 'Thử nghiệm mở — miễn phí',
...
teacherCopies.id = inherit('id', {
  ...
  portal: {
    ...
    memberBrief: {
      ...
      body: 'Member melihat pembacaan dasar terlebih dahulu. Selama beta terbuka, pembacaan lebih dalam, transit harian, bulanan, dan tahunan dapat diakses sepenuhnya. Guide bisa meninjau pertanyaan dan konteks bagan kelahiran sebelum sesi.',
    ...
    tableTime: 'Waktu',
    tableStatus: 'Status',
    tableAmount: 'Status beta',
    tableReminder: 'Pengingat',
    freeTest: 'Beta terbuka — gratis',
...
teacherCopies.ja = inherit('ja', {
  ...
  portal: {
    ...
    memberBrief: {
      ...
      kicker: 'MEMBER CONTEXT',
      title: 'メンバーコンテキストメモ',
      body: 'メンバーはまず基本的な解説を確認します。オープンベータ期間中は、より深い解説や流日・流月・流年の情報もすべて閲覧できます。ガイドはセッション前にメンバーの質問と命盤の文脈を確認できます。',
...
teacherCopies.ko = inherit('ko', {
  ...
  portal: {
    ...
    memberBrief: {
      ...
      kicker: 'MEMBER CONTEXT',
      title: '회원 맥락 요약',
      body: '회원은 먼저 기본 해석을 확인합니다. 오픈 베타 기간 중에는 더 깊은 해석, 일운·월운·연운도 모두 열람 가능합니다. 가이드는 세션 전 회원의 질문과 명반 맥락을 미리 확인할 수 있습니다.',
