...
DAY_MASTER_GUIDE = {
    "甲": "你的日主是甲木，像一棵立定方向、扎根往上的大樹。你重視原則，有長遠的眼光，也有一股安靜卻持續的意志力。適合用慢慢累積代替急著衝刺，影響力會隨著時間自然長出來。",
    "乙": "你的日主是乙木，像在山間尋路生長的藤花，柔韌又細膩。你不見得走最直的路，但很擅長在各種限制裡找到屬於自己的出口——這是很珍貴的適應力。",
    "丙": "你的日主是丙火，像太陽一樣外放、自然帶動氣氛。你的熱情是真實的，讓身邊的人感覺被照亮。把這份熱情連到一個清楚的方向，通常會走得更穩、更有力氣。",
    "丁": "你的日主是丁火，像一盞燭光，細緻而溫暖，能照見別人不一定注意到的細節。你需要被理解，也很能用自己的溫度默默影響他人——只要記得先讓自己被看見。",
    "戊": "你的日主是戊土，像大山一樣穩重、有承擔力。身邊的人很容易在你這裡找到安全感。要留意的是，不必把所有人的重量都扛上身——先讓自己站穩，你的支撐力才能長久。",
    "己": "你的日主是己土，像肥沃的田園，包容、務實，能孕育很多好事。你適合慢慢養出成果，不用每件事都那麼急。也留意一下，有時候別人的問題不見得需要你來收拾。",
    "庚": "你的日主是庚金，直接、果斷，像一把有開創力的刀。你擅長切開混亂、找到重點。偶爾也讓自己軟一點——精準很重要，但保留一點彈性會讓你走得更自在。",
    "辛": "你的日主是辛金，像珠玉一樣，審美敏銳、講究質感。你有獨特的眼光，值得被好好對待。越能保護自己的核心價值，你的光澤就越能自然散發出來。",
    "壬": "你的日主是壬水，像大海一樣視野廣、流動力強。你能快速吸收複雜的資訊，適應各種環境。給自己足夠的流動空間，不要被框住——這樣比較容易找到資源連結和合適的機會。",
    "癸": "你的日主是癸水，像雨露一樣細膩、滲透力強，感受很深。那些在安靜中浮現的感覺，值得多留意、多觀察——當然，重要決定還是可以搭配現實情況一起判斷。",
}

PILLAR_ROLES = {
    "year": ("年柱", "你出生的大環境、家族底色，以及外人初次接觸你時容易感受到的氣質"),
    "month": ("月柱", "你在工作和社會角色裡最常展現的那一面，也反映出生季節給你帶來的能量底氣"),
    "day": ("日柱", "這裡是你自己——最貼近你內心的部分，以及你在最親近的關係裡真實的樣子"),
    "time": ("時柱", "你內心深處的渴望與長遠方向，包括晚年的積累方式與你獨特的創造力來源"),
}
